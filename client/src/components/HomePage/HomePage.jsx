...
export const HomePage = () => {
  ...
  const handleSave = async () => {
    try {
      ...
      if (response.ok) {
        console.log('Przedmiot został dodany pomyślnie');
        // Tutaj możesz dodać dodatkową logikę, np. zamknięcie modala, odświeżenie listy przedmiotów itp.
        handleClose();
      } else {
        console.error('Błąd podczas dodawania przedmiotu:', response.statusText);
      }
    } catch (error) {
